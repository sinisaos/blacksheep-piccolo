Starter application template using [Piccolo ORM](https://piccolo-orm.com/) ecosystem (with [BlackSheep](https://www.neoteroi.dev/blacksheep/) framework) as backend and [Vue.js](https://vuejs.org/) as frontend.
